...
--
-- Name: genres; Type: TABLE; Schema: public; Owner: narawishing
--
...
ALTER TABLE public.genres OWNER TO narawishing;

--
-- Name: genres_id_seq; Type: SEQUENCE; Schema: public; Owner: narawishing
--
...
--
-- Name: movies; Type: TABLE; Schema: public; Owner: narawishing
--
...
ALTER TABLE public.movies OWNER TO narawishing;

--
-- Name: movies_genres; Type: TABLE; Schema: public; Owner: narawishing
--
...
ALTER TABLE public.movies_genres OWNER TO narawishing;

--
-- Name: movies_genres_id_seq; Type: SEQUENCE; Schema: public; Owner: narawishing
--
...
--
-- Name: movies_id_seq; Type: SEQUENCE; Schema: public; Owner: narawishing
--
...
--
-- Name: users; Type: TABLE; Schema: public; Owner: narawishing
--
...
ALTER TABLE public.users OWNER TO narawishing;

--
-- Name: users_id_seq; Type: SEQUENCE; Schema: public; Owner: narawishing
--
...
--
-- Data for Name: genres; Type: TABLE DATA; Schema: public; Owner: narawishing
--
...
--
-- Data for Name: movies; Type: TABLE DATA; Schema: public; Owner: narawishing
--
...
12	inception	2010-07-16	148	PG-13	This movie is inception	inception.jpg	2024-10-04 15:59:16.800802	2024-10-04 15:59:16.800802
\.


--
-- Data for Name: movies_genres; Type: TABLE DATA; Schema: public; Owner: narawishing
--
...
--
-- Data for Name: users; Type: TABLE DATA; Schema: public; Owner: narawishing
--
...
--
-- Name: genres_id_seq; Type: SEQUENCE SET; Schema: public; Owner: narawishing
--
...
--
-- Name: movies_genres_id_seq; Type: SEQUENCE SET; Schema: public; Owner: narawishing
--

SELECT pg_catalog.setval('public.movies_genres_id_seq', 27, true);


--
-- Name: movies_id_seq; Type: SEQUENCE SET; Schema: public; Owner: narawishing
--
...
--
-- Name: users_id_seq; Type: SEQUENCE SET; Schema: public; Owner: narawishing
--
...
--
-- Name: genres genres_pkey; Type: CONSTRAINT; Schema: public; Owner: narawishing
--
...
--
-- Name: movies_genres movies_genres_pkey; Type: CONSTRAINT; Schema: public; Owner: narawishing
--
...
--
-- Name: movies movies_pkey; Type: CONSTRAINT; Schema: public; Owner: narawishing
--
...
--
-- Name: users users_pkey; Type: CONSTRAINT; Schema: public; Owner: narawishing
--
...
--
-- Name: movies_genres movies_genres_genre_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: narawishing
--
...
--
-- Name: movies_genres movies_genres_movie_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: narawishing
--
